...
def data_to_html():
    ...
    with open(index_path, 'w') as data_html:
        ...
        data_html.write('    overflow-y: auto;\n')
        data_html.write('}\n')
        data_html.write('thead, tbody {\n')
        data_html.write('    display: block;\n')
        data_html.write('}\n')
        data_html.write('tbody {\n')
        data_html.write('    max-height: 82vh; /* Altura máxima de la tabla */\n')
        data_html.write('    overflow-y: scroll;\n')
        data_html.write('}\n')
        data_html.write('th, td {\n')
        data_html.write('    border: 1px solid black;\n')
        data_html.write('    padding: 8px;\n')
        data_html.write('    text-align: center;\n')
        data_html.write('}\n')
        data_html.write('th {\n')
        data_html.write('    position: sticky;\n')
        data_html.write('    top: 0;\n')
        data_html.write('    background-color: white;\n')
        data_html.write('}\n')
        data_html.write('</style>\n')
        ...
        data_html.write('<div style="height: 12vh;">')
